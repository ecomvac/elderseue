...
const CustomBar = () => {
  ...
  const critical = "20%";
  return (
    <div className='w-[237px] h-[18px] flex items-center gap-[3px] rounded-full'>

      <div style={{ width: problem }} className={`cursor-pointer h-full bg-[#5C76FF] relative group`}>
      ...
      <div style={{ width: critical }} className={`cursor-pointer  h-full bg-[#F83333] group relative`}>
        <div className=' bg-text-primary rounded-[10px] p-2.5 text-white absolute top-[-10px] left-1 group-hover:flex items-center gap-2 duration-300 hidden '>
