...
const SubscriptionType = ({ data, plan }) => {
    ...
    return (
        <div>
            {plan === 'essential' ? ''
                :
                <div className='px-7 py-5 mt-5 flex justify-between border border-primary rounded-[20px] bg-[#F4EBFF]'>
                    <div className='flex items-center gap-[14px]'>
                        ...
                        <h1 className="text-[#9039FF] font-bold text-lg flex items-center">Upgrade to {plan} and Unleash Powerful New Features!</h1>
                    </div>
