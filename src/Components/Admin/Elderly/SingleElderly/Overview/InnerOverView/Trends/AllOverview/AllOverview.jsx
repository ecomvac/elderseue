...
const AllOverview = ({ trendsData,chartData}) => {
    ...
    return (
        <div className='xl:flex  rounded-b-[30px]'>
            ...
            <div className='w-full xl:w-2/3  border-l mt-0 xl:-mt-[150px] h-[92vh] overflow-y-auto'><OverViewChart handleTrendClick={handleTrendClick}   data={chartData}></OverViewChart></div>
        </div>
    );
};
