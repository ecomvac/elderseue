    ...
    <div className="relative">
      ...
      >
        <button
          ...
          className={` bg-primary/10 w-[110px] text-[13px] h-[40px] text-primary font-medium cursor-pointer px-2 py-2 flex items-center rounded-[10px] justify-between ${!selected && " text-primary"
