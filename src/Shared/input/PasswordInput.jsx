...
const PasswordInput = ({label,label2,register,placeholder}) => {
  ...
  return ( 
         <div className="flex flex-col items-start w-full mt-5 relative">
            ...
            <input
           className="py-[18px] h-[50px] px-4  text-text-primary placeholder:text-[#A3AED0]  rounded-[16px] w-full text-[16px] outline-none border-[#90969D] border-[1px] focus:border-primary"
