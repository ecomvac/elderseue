...
import image from "../../../src/assets/icon/new/Icon.png"
import image2 from "../../../src/assets/icon/new/Cross.png"
    ...
    >
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="ml-3 flex-1">
            <p className="text-[19px] mb-[-5px] font-medium text-white">
              Success
            </p>
            <p className="text-[13px] font-[400] text-white">
              {text}
            </p>
          </div>
        </div>
