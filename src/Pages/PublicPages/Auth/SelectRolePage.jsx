          ...
          <div className="">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
              <div className="flex flex-col items-start ">
                ...
                <input
                  className="py-[18px] px-[16px] h-[50px] text-[#3D4854] placeholder:text-[#A3AED0]  rounded-[16px] w-full text-[16px] outline-none border-[#90969D] border-[1px] focus:border-primary"
                  type="email"
